        ...
        >
          <div>
            ...
            <div className="space-y-6 text-white/80">
              <p className="text-lg">
                Мы — компания, специализирующаяся на архитектурных проектах
                разработке концепций, фасадов зданий и дизайне интерьера.
              </p>
              <p className="text-lg">
                Имея опыт работы более 8 лет, мы помогаем нашим клиентам
                создавать уникальные и гармоничные пространства, начиная с
                разработки концептуальных решений и заканчивая полной
                реализацией проектов, соответствующих современным требованиям.
              </p>
              <p className="text-lg">
                Наш состав состоит из опытных архитекторов, дизайнеров и
                инженеров, которые работают с учетом всех сторон каждого
                проекта.
              </p>
              <p className="text-lg">
                Мы предлагаем индивидуальный подход к каждому клиенту,
                гарантируя высокое качество, внимание к деталям и инновациям.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 md:mt-0">
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              ...
              <a
                href="https://api.whatsapp.com/send/?phone=996505459505&text&type=phone_number&app_absent=0"
                target="_blank"
